...
#ifdef CONFIG_MTK_SPEAKER
// Modified for class D by yi.zheng.hz@tcl.com begin
static int Speaker_mode = AUDIO_SPEAKER_MODE_D;//AUDIO_SPEAKER_MODE_AB;
// Modified for class D by yi.zheng.hz@tcl.com end
...
/* Modified by jiaqing.yang.hz@tcl.com 20150414 begin */
#if 0
// Modified by yi.zheng.hz@tcl.com temply begin
#if 1
...
#endif
// Modified by yi.zheng.hz@tcl.com end
#else
    mt_set_gpio_out(GPIO_EXT_SPKAMP_EN_PIN, GPIO_OUT_ONE);
#endif
/* Modified by jiaqing.yang.hz@tcl.com 20150414 end */
        printk("Ext_Speaker_Amp_Change ON- \n");
    }
    else
    {
...
/* Modified by jiaqing.yang.hz@tcl.com 20150414 begin */
#if 0
// Modified by yi.zheng.hz@tcl.com begin
#if 1
    mt_set_gpio_dir(GPIO99,GPIO_DIR_OUT); // output
    mt_set_gpio_out(GPIO99,GPIO_OUT_ZERO); // high
#endif
