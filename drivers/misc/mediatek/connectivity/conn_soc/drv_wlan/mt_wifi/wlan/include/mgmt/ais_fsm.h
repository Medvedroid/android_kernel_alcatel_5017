...
//modified by zhaoyun.wu 288667
#define AIS_DELAY_TIME_OF_DISC_SEC_ONLY_2G4 15 //2.4G scan need about 0.5s, so delay 2s to reconnect is enough
#define AIS_DELAY_TIME_OF_DISC_SEC_DUALBAND	15 //2.4G scan need about 3.3s, so delay 5s to reconnect is enough
//modified by zhaoyun.wu 288667
