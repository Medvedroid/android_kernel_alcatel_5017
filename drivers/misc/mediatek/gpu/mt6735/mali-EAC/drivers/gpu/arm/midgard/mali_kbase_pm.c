...
/* Merge patch ALPS02147568(For_JHZ6735M_65C_L_ALPS.L1.MP3.V1_P55) by [peng.tian.hz] at [2015.06.25] begin */
  {3, 3, (const int[]){0,1,2}}, // Denali-3(MT6753T);  
/* Merge patch ALPS02147568(For_JHZ6735M_65C_L_ALPS.L1.MP3.V1_P55) by [peng.tian.hz] at [2015.06.25] end */
};
