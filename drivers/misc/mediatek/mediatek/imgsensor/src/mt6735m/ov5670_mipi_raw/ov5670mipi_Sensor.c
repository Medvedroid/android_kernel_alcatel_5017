...
int otp_flag,vcm_id; //Defect 557175 modify by zhanyong.yin at 20150906
...
static int ov5670_read_otp(void)
{
  ...
  /*Defect 557175 modify by zhanyong.yin at 20150906 begin*/
	int awb_flag,addr,temp,i,sensor_id;
  ...
  /*Defect 557175 modify by zhanyong.yin at 20150906 end*/
	...
	return 0; //Defect 557175 modify by zhanyong.yin at 20150906
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	//int vcm_id; //Defect 557175 modify by zhanyong.yin at 20150906
			...
			/*Defect 557175 modify by zhanyong.yin at 20150906 end*/
				{			
					LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);	  
                                	sprintf(Back_Camera_Name,"OV5670:E-WELLY:SUP1:5M_FF");  
					return ERROR_NONE;
				}
				else
				{
