...
// TODO: waiting for PMIC API
//#define cpu_dvfs_is_extbuck_valid()     (is_ext_buck_exist() && is_ext_buck_sw_ready())
#define cpu_dvfs_is_extbuck_valid()     (is_ext_buck_exist())
...
static int _mt_cpufreq_set_cur_volt_extbuck(struct mt_cpu_dvfs *p, unsigned int volt) /* volt: vproc (mv*100) */
{
...
#if 0    // TODO: waiting for PMIC API
    ...
    if (volt > cur_vproc) {
        ...
        do {
            ...
            pmic_set_register_value(PMIC_VSRAM_VOSEL_ON, VOLT_TO_PMIC_VAL(cur_vsram));
