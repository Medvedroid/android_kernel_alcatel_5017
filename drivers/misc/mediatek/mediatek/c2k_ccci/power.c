		...
		cmd, unsigned long arg)
{
	...
	case CMDM_IOCTL_ENTER_FLIGHT_MODE:
		...
		/* [521562] merge ALPS02212031(For_JHZ6735M_65C_L_ALPS.L1.MP3.V1_P83) patch by liming.zhu at 20150818 bigen*/
		c2k_power_off_modem();
		if(!GPIO_C2K_VALID(GPIO_C2K_MDM_PWR_IND))
			modem_notify_event(MDM_EVT_NOTIFY_POWER_OFF);
/* [521562] merge ALPS02212031(For_JHZ6735M_65C_L_ALPS.L1.MP3.V1_P83) patch by liming.zhu at 20150818 end*/			
