...
static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO("BU64241AF", 0x25)};//0x18


#define BU64241_DRVNAME "BU64241AF"
#define BU64241_VCM_WRITE_ID           0x18//0x18
...
static struct platform_driver g_stBU64241_Driver = {
    ...
    .driver		= {
        .name	= "lens_actuator_bu64241",
        .owner	= THIS_MODULE,
    }
};

static struct platform_device g_stBU64241_device = {
    .name = "lens_actuator_bu64241",
    .id = 0,
    .dev = {}
};
...
static int __init BU64241_i2C_init(void)
{
    ...
    if(platform_device_register(&g_stBU64241_device)){
        BU64241DB("failed to register AF driver\n");
        return -ENODEV;
    }
