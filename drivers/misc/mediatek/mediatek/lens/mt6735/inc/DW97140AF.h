...
#define DW97140AFIOC_G_MOTORINFO _IOR(DW97140AF_MAGIC, 0, stDW97140AF_MotorInfo)

#define DW97140AFIOC_T_MOVETO _IOW(DW97140AF_MAGIC, 1, u32)

#define DW97140AFIOC_T_SETINFPOS _IOW(DW97140AF_MAGIC, 2, u32)

#define DW97140AFIOC_T_SETMACROPOS _IOW(DW97140AF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define DW97140AFIOC_G_MOTORMETAINFO _IOR(DW97140AF_MAGIC, 4, stDW97140AF_MotorMETAInfo)
#endif
