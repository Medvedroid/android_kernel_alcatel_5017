...
struct workqueue_struct *led_workqueue = NULL;
...
static int __init mt65xx_leds_probe(struct platform_device *pdev)
{
    ...
    mt_set_gpio_dir(GPIO_PWM_LED, GPIO_DIR_OUT);
    mt_set_gpio_out(GPIO_PWM_LED, GPIO_OUT_ONE);
    //[581718][[Charging LED]Ergo development for Charging LED] by [bin.song] at [2014.1.6] begin
	/*[439014] Led is always light in low power. modify liming.zhu at 20150805 bigen*/
	...
	for (i = 0; i < MT65XX_LED_TYPE_TOTAL; i++) {
		...
		case MT65XX_LED_MODE_CUST_BLS_PWM:
			...
			((cust_set_brightness) (g_leds_data[i]->cust.data)) (0);
			 //modify by llf for PR340854 in 20150710
			((cust_set_brightness) (g_leds_data[i]->cust.data)) (-1);
			break;
