...
static struct notifier_block cpu_nfb __cpuinitdata = {
	...
	/* Merge patch ALPS02143427(For_JHZ6735M_65C_L_ALPS.L1.MP3.V1_P53) by [peng.tian.hz] at [2015.06.24] begin*/
	.priority = 6
	/* Merge patch ALPS02143427(For_JHZ6735M_65C_L_ALPS.L1.MP3.V1_P53) by [peng.tian.hz] at [2015.06.24] end*/
};
