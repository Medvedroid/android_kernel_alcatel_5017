...
struct file *expdb_open(void)
{
	...
	/* [PR467874] Modified by [peng.tian.hz] at [2015.07.27] for open expdb partition error begin */
	if (!filp_expdb || unlikely(filp_expdb == ERR_PTR(-ENOENT)))
	/* [PR467874] Modified by [peng.tian.hz] at [2015.07.27] for open expdb partition error end */
