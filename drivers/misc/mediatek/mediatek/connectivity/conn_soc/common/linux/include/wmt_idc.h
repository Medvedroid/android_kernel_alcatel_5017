...
#if CFG_WMT_LTE_COEX_HANDLING
static INT32 wmt_idc_init(VOID)
{
    return 0;
}
static INT32 wmt_idc_deinit(VOID)
{
    return 0;
}

static INT32 wmt_idc_msg_to_lte_handing(VOID)
{
    return 0;
}

static UINT32 wmt_idc_msg_to_lte_handing_for_test(UINT8 *p_buf,UINT32 len)
{
    return 0;
}
