...
static ssize_t LCM_info_show(struct device *dev,struct device_attribute *attr, char *buf)
{
	...
	char remark[]="0 x 0";
	char na[]="NA:NA:NA:0";
	char icname[]="ILI9806E";//modify by llf for defect 665776 begain
	int lcm_id=0;
	...
	if(plcm) {
		kfree(plcm);
	}//modify by llf for defect 665776 end
