...
*
********************************************************************************/
#define CAM_CAL_DRVNAME "OV5670_CAL_DRV"
...
static int ov5670_eeprom_read = 0;
...
extern int rg_h,bg_h,rg_bg_l,g_ave1;

static int Ov5670_read_otp(u32 offset, BYTE* data,u16 i2c_id,u32 size)
{
    if(offset==0x7011)
	*data=0x44;
...
#endif
{
    ...
    switch(a_u4Command)
    {
        ...
        case CAM_CALIOC_G_READ:
            ...
            do_gettimeofday(&ktv1);
#endif
            Ov5670_read_otp(ptempbuf->u4Offset, pu1Params, OV5670_EEPROM_DEVICE_ID,ptempbuf->u4Length);
...
static const struct file_operations g_stCAM_CAL_fops =
{
    ...
    //.ioctl = CAM_CAL_Ioctl
#ifdef CONFIG_COMPAT
    .compat_ioctl = ov5670eeprom_Ioctl_Compat,
#endif
...
inline static int RegisterCAM_CALCharDrv(void)
{
    ...
    CAM_CAL_class = class_create(THIS_MODULE, "OV5670_CALdrv");
...
static int __init CAM_CAL_init(void)
{
  ...
  //  i2c_register_board_info(CAM_CAL_I2C_BUSNUM, &kd_cam_cal_dev, 1);
    if(platform_driver_register(&g_stCAM_CAL_Driver)){
        CAM_CALERR("failed to register ov5670_eeprom driver\n");
        return -ENODEV;
    }

    if (platform_device_register(&g_stCAM_CAL_Device))
    {
        CAM_CALERR("failed to register ov5670_eeprom driver, 2nd time\n");
        return -ENODEV;
    }
