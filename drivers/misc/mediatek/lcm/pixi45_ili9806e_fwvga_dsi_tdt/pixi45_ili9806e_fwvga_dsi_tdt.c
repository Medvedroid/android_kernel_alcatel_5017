...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	// add by zhuqiang for FR437058 at 2013.4.25 end
 	params->dsi.PLL_CLOCK=208;//add by longfang.liu PR527476
        ...
        //printk(KERN_ERR "[pixi45_ili9806e_fwvga_dsi_tdt.c]Debug MIPI: params->dsi.PLL_CLOCK = %d\n", params->dsi.PLL_CLOCK);
        //printk(KERN_ERR "[pixi45_ili9806e_fwvga_dsi_tdt.c]Debug MIPI: params->dsi.ssc_range = %d\n", params->dsi.ssc_range);
}
