...
/*[293344] porting ALPS02103887(For_JHZ6735M_65C_L_ALPS.L1.MP3.V1_P34) by liming.zhu at 20150602 bigen*/
	udelay(50); /*efuse hw bug, need to wait delay */
	/*[293344] porting ALPS02103887(For_JHZ6735M_65C_L_ALPS.L1.MP3.V1_P34) by liming.zhu at 20150602 end*/
...
void chrdet_int_handler(void)
{
	...
	if (!upmu_get_rgs_chrdet())
	{
		...
		/*[249652] in power off charge mode,charge to 100% then plug out the charger,the led light will blink by liming.zhu at 20150515 begin*/
		mdelay(500);
		/*[249652] in power off charge mode,charge to 100% then plug out the charger,the led light will blink by liming.zhu at 20150515 end*/
	        mt_power_off();
	    }
	}
#endif
