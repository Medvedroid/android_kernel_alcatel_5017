...
struct timespec last_tempreture_error_time_ts_battery;
		...
		is_first_time_error_temp++;
                                    getrawmonotonic(&now_tempreture_error_time);
                                     if(is_first_time_error_temp==1)
                                                      {       
                                                              last_tempreture_error_time_ts_battery.tv_sec=now_tempreture_error_time.tv_sec;
                                                               
                                                       }
                                          delta_tempreture_error_time = now_tempreture_error_time.tv_sec - last_tempreture_error_time_ts_battery.tv_sec;
...
//		BUG();
		...
		//add block shutdown beause of over temperature in MINI sw
		//by ronghui.wang for Task 138993 begin/end
