...
#define AF_DRVNAME "DW97140AF"
#define I2C_SLAVE_ADDRESS        0x1a
#define I2C_REGISTER_ID            0x1a
#define PLATFORM_DRIVER_NAME "lens_actuator_DW97140af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_DW97140af"
...
inline static int getAFInfo(__user stDW97140AF_MotorInfo * pstMotorInfo)
{
    stDW97140AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stDW97140AF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW97140AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stDW97140AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stDW97140AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW97140AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW97140AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW97140AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW97140AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case DW97140AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case DW97140AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case DW97140AFIOC_T_SETMACROPOS :
...
static int AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    char puSendCmd2[2]={(char)(0xA1),(char)(0x0E)};
    ...
    if (i4RetValue < 0) 
    {
        LOG_INF("[dw97140] I2C send failed!! \n");
      //  return -1;
    }
    else
   {
...
static int AF_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    g_pstAF_I2Cclient->addr = I2C_SLAVE_ADDRESS-2;
...
static int __init DW97140AF_i2C_init(void)
{
...
static void __exit DW97140AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(DW97140AF_i2C_init);
module_exit(DW97140AF_i2C_exit);

MODULE_DESCRIPTION("DW97140AF lens module driver");
