...
#define AF_DRVNAME "DW9814AF"
#define I2C_SLAVE_ADDRESS        0x19
#define I2C_REGISTER_ID            0x19
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9814af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9814af"
...
static int s4AF_WriteReg(u16 a_u2Data)
{
    ...
    //LOG_INF("TCL: g_sr %d, write target is %d \n", g_sr, a_u2Data);
...
inline static int getAFInfo(__user stDW9814AF_MotorInfo * pstMotorInfo)
{
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9814AF_MotorMETAInfo * pstMotorMETAInfo)
{
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9814AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9814AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9814AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9814AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
...
static int AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
   ...
   i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd2, 2);
    ...
    LOG_INF("TCL:dw9814 init success\n");
