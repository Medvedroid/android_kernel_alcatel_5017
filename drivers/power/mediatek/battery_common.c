...
#include "cust_pe.h"
#endif
/*[964522] change battery charge behave accord with Temperature Behavior Definition_V1 0_20140715.docx by liming.zhu at 201500404 bigin*/
...
#endif
extern kal_int32 gFG_voltage_sw_ocv_flag;
extern kal_int32 gFG_voltage_hw_ocv_flag;
extern  kal_int32 gFG_capacity_by_v_init_flag;
/*[326405] battery dicharged too fast by liming.zhu.hz at 20150614 bigen*/
#ifdef CONFIG_CAR_TUNE_VALUE_Check
#ifdef CAR_TUNE_VALUE_Debug
int CAR_TUNE_VALUE = 40;
#else
int CAR_TUNE_VALUE = 80;
#endif
#endif
...
static void battery_update(struct battery_data *bat_data)
{
	...
	kal_bool resetBatteryMeter = KAL_FALSE;
	#ifdef CONFIG_CAR_TUNE_VALUE_Check
	kal_bool resetBatteryMeter_TuneValue=KAL_FALSE;
	#endif
...
/*[326405] battery dicharged too fast by liming.zhu.hz at 20150614 bigen*/
			...
			resetBatteryMeter_TuneValue = battery_car_tune_low_check_in_chargefull(); // soc>=99
			else
			resetBatteryMeter_TuneValue = battery_car_tune_high_check_in_chargefull(); //soc<99
			#endif
/*[326405] battery dicharged too fast by liming.zhu.hz at 20150614 end*/			
...
/*[326405] battery dicharged too fast by liming.zhu.hz at 20150614 bigen*/
			#ifdef CONFIG_CAR_TUNE_VALUE_Check
			if(BMT_status.SOC==1)
			resetBatteryMeter_TuneValue=battery_car_tune_low_check_in_1percentage(); //soc=1
			else
			resetBatteryMeter_TuneValue=battery_car_tune_high_check_in_low_percentage(); //soc>1
			#endif
/*[326405] battery dicharged too fast by liming.zhu.hz at 20150614 end*/		
...
/*[326405] battery dicharged too fast by liming.zhu.hz at 20150614 bigen*/		
			{
			#ifndef CONFIG_CAR_TUNE_VALUE_Check
...
/*[326405] battery dicharged too fast by liming.zhu.hz at 20150614 bigen*/
#ifdef CONFIG_CAR_TUNE_VALUE_Check
if ((resetBatteryMeter == KAL_TRUE)||(resetBatteryMeter_TuneValue==KAL_TRUE)) 
#else
...
/*[964522] [pixi34TF] [mt 6581] change battery charge behave accord with Temperature Behavior Definition_V1 0_20140715.docx  by [limng.zhu] at [20150331] bigen*/
	if (BMT_status.temperature <= MIN_CHARGE_TEMPERATURE) 
/*[964522] [pixi34TF] [mt 6581] change battery charge behave accord with Temperature Behavior Definition_V1 0_20140715.docx  by [limng.zhu] at [20150331] end*/	
	{
		battery_log(BAT_LOG_CRTI,
...
void mt_battery_GetBatteryData(void)
{
	...
	battery_log(BAT_LOG_CRTI,
			    "AvgVbat=(%d),bat_vol=(%d),AvgI=(%d),I=(%d),VChr=(%d),AvgT=(%d),T=(%d),pre_SOC=(%d),SOC=(%d),ZCV=(%d) SW_OCV=%d,HW_OCV=%d,init_dod=%d\n",
			    BMT_status.bat_vol, bat_vol, BMT_status.ICharging, ICharging,
			    BMT_status.charger_vol, BMT_status.temperature, temperature,
			    previous_SOC, BMT_status.SOC, BMT_status.ZCV,
			    gFG_voltage_sw_ocv_flag,gFG_voltage_hw_ocv_flag,gFG_capacity_by_v_init_flag);
...
#if BATT_ID_CHECK_SUPPORT
#define CHG_MIN_VALID_BATT_ID_BYD  324
#define CHG_MAX_VALID_BATT_ID_BYD  524
#define CHG_MIN_VALID_BATT_ID_SCUD  1243
#define CHG_MAX_VALID_BATT_ID_SCUD  1443
...
{
/*[CR651742][Soul45][charge]battery can't charge full by [wangxingxing] at [20140415] begin*/
#ifndef TARGET_BUILD_MMITEST
#if BATT_ID_CHECK_SUPPORT
int battery_id_fail=0;
...
#endif
#endif
/*[CR651742][Soul45][charge]battery can't charge full by [wangxingxing] at [20140415] end*/
...
/*[964522] change battery charge behave accord with Temperature Behavior Definition_V1 0_20140715.docx by liming.zhu at 201500404 bigen*/
       ...
       kal_int32 delta_tempreture_error_time = 0;
       static kal_int32 total_tempreture_error_time = 0;
...
/*[964522] change battery charge behave accord with Temperature Behavior Definition_V1 0_20140715.docx by liming.zhu at 201500404 end*/
	if ((g_battery_thermal_throttling_flag == 1) || (g_battery_thermal_throttling_flag == 3)) {
		...
		/* ignore default rule */
#else
		/* [815537] [MT6582] [Pixi335] Modify behavior while temperature is over 60C or under -20C by [liming.zhu.hz] at [2014.10.22] begin*/
		if((BMT_status.temperature >= 60 )||(BMT_status.temperature <= -20))
		/* [815537] [MT6582] [Pixi335] Modify behavior while temperature is over 60C or under -20C by [liming.zhu.hz] at [2014.10.22] end*/  {
/*[964522] change battery charge behave accord with Temperature Behavior Definition_V1 0_20140715.docx by liming.zhu at 201500404 bigen*/
...
/*[326405] battery dicharged too fast by liming.zhu.hz at 20150614 bigen*/	
	...
	#ifdef CONFIG_CAR_TUNE_VALUE_Check
       static kal_bool battery_car_tune_initilized = KAL_FALSE;
       int car_tune_temp = 0;
    if(battery_car_tune_initilized == KAL_FALSE)
    {
        battery_car_tune_initilized = battery_read_tune_cfg(&car_tune_temp);
        if(battery_car_tune_initilized)
        {
            if(car_tune_temp == 0)
            {
...
/*[326405] battery dicharged too fast by liming.zhu.hz at 20150614 end*/
	...
	// add block check battery temperature in MINI sw
	// by ronghui.wang for Task 138993 at 20150316 begin/end
	#ifndef TARGET_BUILD_MMITEST
	/*[158891] for high or low temperrature test by liming.zhu at 20150407 bigen*/
	#ifndef CONFIG_HIGH_LOW_TEMPERRATURE_TEST
	/*#[158891] for high or low temperrature test by liming.zhu at 20150407 end*/
