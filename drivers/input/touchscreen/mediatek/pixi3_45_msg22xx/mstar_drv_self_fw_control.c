...
{
	#include "Pixi3-4.5_byd_2238_V0XE.001_20150330.h"
};
unsigned char msg2xxx_xxxx_update_bin[94*1024] =
{
	#include "PIXI3-4.5_TXD_2238_V0xC.206_20150703.h"
};
...
void _DrvFwCtrlMsg22xxCheckFirmwareUpdateBySwId(void)
{
    ...
    if (nCrcMainA == nCrcMainB && nCrcInfoA == nCrcInfoB) // Case 1. Main Block:OK, Info Block:OK
    {
        ...
        if (eSwId == MSG22XX_SW_ID_XXXX || eSwId == 0x01)
        {
